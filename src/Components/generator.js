...
const femaleFirstNames = ['Aritzia', 'H&M', 'Gap', 'Lululemon', 'Zara', 'A&E', 'Victoria Secret', 'Patagonia', 'Uniqlo'];
const maleFirstNames = ['Gildan', 'Adidas', 'Gucci', 'Louis Vuitton', 'Channel', 'Nike', 'Rolex', 'Levi', 'Prada'];
const lastNames = [
...
const cities = ['USA', 'Bangledesh', 'Indonesia', 'Vietnam', 'Thailand', 'Japan', 'Brazil', 'Vietnam', 'China'];
const cars = ['Polyester, Nylon', 'Cotton, Synthetic Material', 'Leather, Cotton', 'Synthetic Material', 'Organic Cotton, Recyled Down, Experimental Fabric', 'Polyester, Nylon', 'Denim', 'Flannel, Denim'];
