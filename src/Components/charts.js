...
import { oilProduction } from './data-vizualization';

const consumptionSeriesName = 'Purchases';
...
const series = [
  ...
  {
    name: 'Manufacturing Cost', key: 'price', color: priceColor, scale: 'price', type: SplineSeries,
  },
];
    ...
    return (
      <Paper>
        ...
        >
          ...
          <Title
            text="What factors do you look for when buying new clothing?"
          />
